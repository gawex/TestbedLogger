 ...
 * @license GNU GPL v3
 * @brief   DiscoverDevicesActivity.java
 * @lastmodify 2021/03/05 11:42:00
 * @verbatim
----------------------------------------------------------------------
...
import cz.vsb.cbe.testbed.activitiesAndServices.BluetoothLeService.LocalBinder;
import cz.vsb.cbe.testbed.adapters.ConditionsAdapter;
import cz.vsb.cbe.testbed.adapters.TestbedDevicesAdapter;
...
import static cz.vsb.cbe.testbed.activitiesAndServices.StartUpActivity.FIRST_RUN_APPLICATION_KEY;
...
public class DiscoverDevicesActivity extends AppCompatActivity {
                    ...
                    switch (intent.getAction()) {
                        case BluetoothLeService.ACTION_GATT_CONNECTED:
                            mConnectingToLastConnectedTestbedDeviceConditionsAdapter.setCondition(
                                    ...
                                    getString(R.string.dialog_connecting_to_last_connected_testbed_device_connected) +
                                            ...
                                            TestbedDevice
                                                    .formatTestbedDeviceId(mLastConnectedTestbedDevice) +
                                            ")");
                            mConnectingToLastConnectedTestbedDeviceConditionsAdapter.setCondition(
                        ...
                        case BluetoothLeService.ACTION_GATT_ALL_DESCRIPTORS_WRITTEN:
                            ...
                            new Handler().postDelayed(() -> {
                                ...
                                Intent intentActivity = new Intent(DiscoverDevicesActivity.this,
                                ...
                                switch (mActivityState) {
                                    ...
                                    default:
                                        throw new IllegalStateException(
                                                "Unexpected value of mActivityState: " +
                                                        mActivityState);
                                }
                            ...
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                                ...
                                if (!locationManager.isLocationEnabled()) {
                                    switch (mActivityState) {
                                        ...
                                        default:
                                            throw new IllegalStateException(
                                                    "Unexpected value mActivityState: " +
                                                            mActivityState);
                                    }
                                }
                            }
                        ...
                        case BluetoothLeService.ACTION_GATT_ALL_DESCRIPTORS_WRITTEN:
                            ...
                            new Handler().postDelayed(() -> {
                                ...
                                Intent intentActivity =
                                        new Intent(DiscoverDevicesActivity.this,
                                                DatabaseActivity.class);
                                intentActivity.putExtra(TestbedDevice.TESTBED_DEVICE,
                                        mSelectedTestbedDevice);
                                startActivity(intentActivity);
                                finish();
                            }, SPLASH_TIME_START_ACTIVITY_MS);
                            break;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFirstActivityRun = getIntent().getExtras().getBoolean(FIRST_RUN_APPLICATION_KEY,
                false);
        ...
        lsvDiscoveredTestbedDevices.setOnItemClickListener((parent, view, position, id) -> {
            if (mActivityState == ACTIVITY_STATE.DISCOVERED_STATE) {
                ...
                } else if (mSelectedTestbedDevice.getAvailableSensors() == 0) {
                    AlertDialog deviceDoNotHaveAnySensorsDialog = new AlertDialog.Builder(this)
                            .setIcon(AppCompatResources.getDrawable(this,
                                    R.drawable.ic_bluetooth_20dp_color_red))
                            .setTitle(getString(R.string.dialog_device_do_not_have_any_sensors_title))
                            .setMessage(getString(R.string.dialog_device_do_not_have_any_sensors_message))
                            .setNeutralButton(
                                    getString(R.string.dialog_device_do_not_have_any_sensors_button),
                                    (dialog, which) -> {
                                        mDiscoveredTestbedDevicesAdapter.clear();
                                        mDiscoveredTestbedDevicesAdapter.notifyDataSetChanged();
                                        mTxvNoDevicesFound.setVisibility(View.VISIBLE);
                            ...
                            .create();
                    deviceDoNotHaveAnySensorsDialog.show();
                } else {
                    connectToSelectedTestbedDevice(mSelectedTestbedDevice);
                }
            }
        ...
        final View connectingToLastConnectedTestbedDeviceDialoView = getLayoutInflater().
        ...
        final View connectingToSelectedTestbedDeviceDialoView =
    ...
    protected void onResume() {
        ...
        bindService(new Intent(this, BluetoothLeService.class),
                mBluetoothLeServiceConnection, BIND_AUTO_CREATE);
