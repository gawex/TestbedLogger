...
import static cz.vsb.cbe.testbed.activitiesAndServices.BluetoothLeService.NOTIFICATION_CHANNEL_ID;

@SuppressWarnings("AccessStaticViaInstance")
public class StartUpActivity extends AppCompatActivity {

    public static final String FIRST_RUN_APPLICATION_KEY =
            "cz.vsb.cbe.testbed.FIRST_RUN_APPLICATION";
    ...
    private void continueApplication() {
        ...
        new Handler().postDelayed(() -> {
            ...
            intent.putExtra(FIRST_RUN_APPLICATION_KEY, true);
            startActivity(intent);
            finish();
        }, SPLASH_TIME_MS);
    }
