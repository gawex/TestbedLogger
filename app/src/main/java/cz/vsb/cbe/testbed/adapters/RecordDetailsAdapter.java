 ...
 * @lastmodify 2021/03/05 11:44:26
 * @verbatim
----------------------------------------------------------------------
                ...
                case RECORD_VALUE:
                    switch (record.getDataKey()) {
                        case BluetoothLeService.STEPS_DATA:
                            ...
                            mValue = RecordValueFormatter.formatSteps(
                        ...
                        case BluetoothLeService.HEART_RATE_DATA:
                            ...
                            mValue = RecordValueFormatter.formatHearRate(
                        ...
                        case BluetoothLeService.TEMPERATURE_DATA:
                            ...
                            mValue = RecordValueFormatter.formatTemperature(
                    ...
                    mLabelId = R.string.record_details_dialog_record_value_label;
                    break;

                case RECORD_TIMESTAMP:
                    mIconDrawableId = R.drawable.ic_timestamp_20dp_color_fei;
                    mLabelId = R.string.record_details_dialog_record_timestamp_label;
                    mValue = RecordValueFormatter.formatTimeStampFull(record.getTimeStamp());
                    break;
